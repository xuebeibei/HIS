...
const QString strDBName = "D:/sqlite/test.db";
const QString strDBTableName = "department";
...
const QString strChargeNumGroup = "收费单信息";
const QString strChargeNumLabel = "收费单号：";
